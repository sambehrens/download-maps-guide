...
export default {
    title: 'How to download maps for offline navigation',
    steps: [
        {
        ...
        },
        {
            title: 'Select Area',
            description:
                'Drag the map around until all of the area you wanted to download is in the blue box. Be sure to include cities that may be on or outside the edge, like Dublin.',
            image: image7,
